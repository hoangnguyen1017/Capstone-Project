...
MODEL_PATH = r"C:\Users\ADMIN\Downloads\Do_an\System_goc\System\Docker\best_full_checkpoint.pth"
...
probs_queue = deque(maxlen=SMOOTH_LEN)
...
def predict():
    try:
        ...
        return jsonify({ "success": True, "prediction": LABELS[pred_idx], "confidence": pred_conf, "probs": probs.tolist()})
